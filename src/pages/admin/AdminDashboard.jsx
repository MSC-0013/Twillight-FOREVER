      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-6 lg:space-y-0">
            <div className="space-y-2">
              ...
              <p className="text-gray-600 text-lg max-w-2xl">
                Comprehensive dashboard for managing your e-commerce empire with
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Button
                asChild
                variant="outline"
                className="border-blue-200  hover:border-blue-300 transition-all"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-10">
          {statCards.map((stat, index) => (
            <Card
              key={index}
              className="relative overflow-hidden hover:shadow-xl transition-all duration-500 border-0 shadow-lg bg-white  group"
            >
              <CardContent className="p-6">
                ...
                <div
                  className={`absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r ${stat.color} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300`}
                ></div>
              </CardContent>
            </Card>
          ))}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <Button
                              ...
                              className="  bg-black text-white transition-opacity "
                            >
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                {featuredProducts.map((product, index) => (
                  <div
                    key={product.id}
                    className="flex items-center gap-4 p-3 border border-gray-100 rounded-xl hover:bg-gray-50 transition-all duration-200 group"
                  >

        ...
        <div className="relative z-10 flex items-center justify-center h-full text-white text-center px-4">
          <div className="max-w-4xl animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{animationDelay: '0.4s'}}>
              ...
              <Button size="lg" variant="outline" className=" text-white px-8 py-4 text-lg hover-scale">
                Explore Collection
              </Button>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-16 animate-fade-in">
            ...
            <Button variant="outline" asChild className="border-black text-white  hover-scale">
              <Link to="/products">
      ...
      <section className="py-20 bg-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className=" bg-white  text-black  hover:bg-white hover:text-black px-8 py-4 text-lg hover-scale">
              <Link to="/products">
                Start Shopping
              </Link>
            </Button>

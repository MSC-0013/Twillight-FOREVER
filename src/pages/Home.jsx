...
const Home = () => {
  //product IDs
  const featuredProductIds = ['6', '3', '7', '1'];
  const newProductIds = ['39', '5', '9', '52'];
  const bestSellerProductIds = ['4', '13', '8', '10'];

  const featuredProducts = products.filter((p) =>
    featuredProductIds.includes(p.id)
  );
  const newProducts = products.filter((p) => newProductIds.includes(p.id));
      ...
      <section className="relative h-[80vh] overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center h-full text-white text-center px-4">
          <div className="max-w-3xl animate-fade-in">
            <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight animate-scale-in">
              <span className="text-white">FOR</span>
              <span className="text-gray-300">EVER</span>
            </h1>
            <p
              className="text-lg md:text-2xl mb-6 text-gray-200 max-w-2xl mx-auto leading-relaxed animate-fade-in"
              style={{ animationDelay: "0.2s" }}
            >
              {landingBanners[currentBanner]?.subtitle ||
            ...
            >
              <Button
                size="lg"
                asChild
                className="bg-white text-black hover:bg-gray-100 px-6 py-3 text-base hover-scale"
              >
                <Link to="/products">
              ...
              <Link to="/products">
                <Button
                  size="lg"
                  variant="outline"
                  className="text-white px-6 py-3 text-base hover-scale"
                >
                  Explore Collection
                </Button>
              </Link>
        ...
        <button
          ...
          className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white p-2 rounded-full transition-all z-20"
        >
        ...
        <button
          ...
          className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white p-2 rounded-full transition-all z-20"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                desc: "Only the finest products make our catalog",
                delay: "0.4s",
              },
              {
                icon: Clock,
              ...
              },
              {
                icon: Users,
                title: "Expert Team",
                desc: "Curated by product specialists",
                delay: "0.6s",
              },
              {
                icon: Zap,
                title: "Lightning Deals",
                desc: "Exclusive flash sales for members",
                delay: "0.7s",
              },
            ].map((feature, index) => (
              <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-16 animate-fade-in">
            ...
            <Button
              variant="outline"
              asChild
              className="border-black text-white  hover-scale"
            >
              <Link to="/products">
      ...
      <section className="py-20 bg-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
          ...
          <p className="text-xl mb-10 text-gray-300 max-w-2xl mx-auto">
            Experience premium quality and timeless style with over 1 million
            satisfied customers
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              asChild
              className="bg-white text-black hover:bg-gray-100 px-8 py-4 text-lg hover-scale"
            >
              <Link to="/register">
            ...
            <Button
              size="lg"
              variant="outline"
              className=" bg-white  text-black  hover:bg-white hover:text-black px-8 py-4 text-lg hover-scale"
            >

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your premier destination for electronics, fashion, and lifestyle products. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/products?category=sportswear" className="text-gray-400 hover:text-white">Sportswear</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/help" className="text-gray-400 hover:text-white">FAQ</Link></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">support@shopnexus.com</span>
              </div>
              <div className="flex items-center space-x-2">
